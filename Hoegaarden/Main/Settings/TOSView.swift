...
class TOSView: UIViewController {
    ...
    func setConstraints() {
        NSLayoutConstraint.activate([
            tosLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 130),
            tosLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 36)
        ])
        
        NSLayoutConstraint.activate([
            lineView.topAnchor.constraint(equalTo: tosLabel.bottomAnchor, constant: 12),
