...
class TOSView: UIViewController {
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            tosLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 60),
            tosLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 36),
